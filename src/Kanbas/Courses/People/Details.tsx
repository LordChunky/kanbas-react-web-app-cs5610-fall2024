    ...
    return (
        <div className="wd-people-details position-fixed top-0 end-0 bottom-0 bg-white p-4 shadow w-25">
            ...
            <div> 
                ...
                {!editing && (
                    <div> 
                        <div className="wd-name text-danger fs-4 wd-name" onClick={() => setEditing(true)}>
                            {user.firstName} {user.lastName}
                        </div>           
                        <span className="wd-email text-dark fs-6 wd-email" onClick={() => setEditing(true)}>         
                            <b>Email: </b>{user.email}         
                        </span> <br />           
                        <span className="wd-roles text-dark fs-6 wd-role" onClick={() => setEditing(true)}>         
                            <b>Roles: </b>{user.role}         
                        </span> <br />
                    </div> )
                } 
